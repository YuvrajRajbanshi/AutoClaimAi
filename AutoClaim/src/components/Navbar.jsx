...
import { FaCarCrash, FaCameraRetro, FaSignInAlt, FaUserPlus } from "react-icons/fa";
    ...
    <div className="bg-gray-900 text-white shadow-md">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="flex space-x-6">
          ...
          <Link to="/upload" className="hover:text-blue-400">Analyze Damage</Link>
          <Link to="/thermal-scanner" className="text-yellow-400 font-semibold hover:text-yellow-300">
